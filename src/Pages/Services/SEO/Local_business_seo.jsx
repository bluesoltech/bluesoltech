      ...
      <div className='md:w-[80%] w-auto mt-4 mx-auto'>
        ...
        <div className='flex items-center justify-center mt-[120px]'>
          <div className=' w-[1300px] h-[180px]'>
            <h1 className='font-bold text-white text-3xl p-4 text-center mb-2'>Would You Like To Discuss Your Project With Our Experts?</h1>
        ...
        <div className='xl:flex flex-row mt-[120px] justify-around'>
          <div className='xl:w-[50%] w-full'>
            <img src={img1} className='' />
          </div>
          <div className='xl:w-[50%] w-full'>
            <h2 className='font-bold items-start xl:items-start justify-start xl:justify-start text-white text-3xl'>Affordable Local SEO Services</h2>
        ...
        <div className='xl:flex flex-row mt-[120px] justify-between items-start'>
          <div className='xl:w-[50%] w-full'>
            <h2 className='font-bold items-start xl:items-start justify-start xl:justify-start text-white text-3xl'>How Local SEO Services Help?</h2>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-center'>What Exactly You Get With Our Local SEO Services In India?</h1>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 text-sm justify-between mt-11'>
            <div className='w-[400px] h-[300px] bg-black border-gray-500 mx-auto hover:border-2 p-4 m-2'>
              ...
              <h1 className='text-white text-2xl mt-4 font-bold text-center'>Google My Business Setup</h1>
              <ul className='mt-6 text-gray-500 text-start px-14 text-[1.1rem] leading-7 '>
                <li>✔️ NAP Syncing</li>
                <li>✔️ Geotagging Photos</li>
                <li>✔️ Business Description</li>
                <li>✔️ Service Area</li>
                <li>✔️ Business Category</li>
              </ul>
            </div>
            <div className='w-[400px] h-[300px] bg-black border-gray-500 mx-auto hover:border-2 p-4 m-2'>
              <div className="flex items-center justify-center">
              ...
              <h1 className='text-white text-2xl mt-4 font-bold text-center'>Local SEO Analysis</h1>
              <ul className='mt-6 text-gray-500 text-start px-14 text-[1.1rem] leading-7 '>
                <li>✔️ Analyzing your local markets</li>
                <li>✔️ Competitor Citation Audit</li>
                <li>✔️ Competitor Backlink Audit</li>
                <li>✔️ Analyzing the competition</li>
                <li>✔️ Google My Business Audit</li>
              </ul>
            </div>
            <div className='w-[400px] h-[300px] bg-black border-gray-500 mx-auto hover:border-2 p-4 m-2'>
              <div className="flex items-center justify-center">
            ...
            <div className='w-[400px] h-[300px] bg-black border-gray-500 mx-auto hover:border-2 p-4 m-2'>
              ...
              <h1 className='text-white text-2xl mt-4 font-bold text-center'>Tracking & Reporting</h1>
              <ul className='mt-6 text-gray-500 text-start px-14 text-[1.1rem] leading-7 '>
                <li>✔️ Tracking The Citations</li>
                <li>✔️ Observing The Local Traffic</li>
                <li>✔️ Observing Competitor Activities</li>
                <li>✔️ Detailed Report And Support</li>
              </ul>
            </div>
            <div className='w-[400px] h-[300px] bg-black border-gray-500 mx-auto hover:border-2 p-4 m-2'>
              <div className="flex items-center justify-center">
              ...
              <h1 className='text-white text-2xl mt-4 font-bold text-center'>NAP Syndication</h1>
              <ul className='mt-6 text-gray-500 text-start px-14 text-[1.1rem] leading-7 '>
                <li>✔️ Building Local Citations</li>
                <li>✔️ Finding Local Bloggers for free or sponsored listing</li>
              </ul>
            </div>
            <div className='w-[400px] h-[300px] bg-black border-gray-500 mx-auto hover:border-2 p-4 m-2'>
              <div className="flex items-center justify-center">
              ...
              <h1 className='text-white text-2xl mt-4 font-bold text-center'>Planning & Brain Storming</h1>
              <ul className='mt-6 text-gray-500 text-start px-14 text-[1.1rem] leading-7 '>
                <li>✔️ Preparing Next Month Plan</li>
                <li>✔️ Consulting</li>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-center'>What Is The Importance Of</h1>
          <p className=' text-[1.1rem] leading-7 items-start xl:items-center justify-start xl:justify-end text-gray-500 text-start xl:text-center mt-2 font-bold text-4xl'>Local SEO Services?</p>
        ...
        <div className='xl:flex flex-row mt-[120px] justify-around'>
          ...
          <div className='xl:w-[50%] w-full'>
            <h2 className='font-bold items-start xl:items-start justify-start xl:justify-start text-white text-3xl'>Why Should You Hire A Local SEO Services Company?</h2>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-center'>How Do We Optimize Your Local Business Website For Better Local SEO <br></br> Results?</h1>
        ...
        <div className='mt-[120px]'>
          ...
          <h1 className='text-gray-500 text-4xl mt-4 font-bold text-center'>Our SEO Results</h1>
          <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 text-sm justify-between mt-11'>
            <div className='w-[300px] h-[200px] border-gray-500 border-2 justify-center items-center text-center mx-auto m-2 overflow-hidden'>
              <img src={img1} />
            </div>
            <div className='w-[300px] h-[200px] border-gray-500 border-2 justify-center items-center text-center mx-auto m-2 overflow-hidden'>
              <img src={img1} />
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-center'>Our Local Business SEO Services Help You To Build</h1>
          <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 text-sm justify-between mt-11'>
            <div className='w-[350px] h-[300px] bg-black justify-center items-center  mx-auto m-2 overflow-hidden p-4 border-gray-500 hover:border-2'>
              <h1 className='text-white text-xl mt-4 font-bold '>Local SEO Friendly URLs</h1>
            ...
            <div className='w-[350px] h-[300px] bg-black justify-center items-center  mx-auto m-2 overflow-hidden p-4 border-gray-500 hover:border-2'>
              <h1 className='text-white text-xl mt-4 font-bold '>Content Marketing</h1>
            ...
            <div className='w-[350px] h-[300px] bg-black justify-center items-center  mx-auto m-2 overflow-hidden p-4 border-gray-500 hover:border-2'>
              <h1 className='text-white text-xl mt-4 font-bold '>Google Map Listing</h1>
            ...
            <div className='w-[350px] h-[300px] bg-black justify-center items-center  mx-auto m-2 overflow-hidden p-4 border-gray-500 hover:border-2'>
              <h1 className='text-white text-xl mt-4 font-bold '>Local Citations Building</h1>
            ...
            <div className='w-[350px] h-[300px] bg-black justify-center items-center  mx-auto m-2 overflow-hidden p-4 border-gray-500 hover:border-2'>
              <h1 className='text-white text-xl mt-4 font-bold '>Local Backlinks</h1>
            ...
            <div className='w-[350px] h-[300px] bg-black justify-center items-center  mx-auto m-2 overflow-hidden p-4 border-gray-500 hover:border-2'>
              <h1 className='text-white text-xl mt-4 font-bold '>Reviews & Ratings</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>Why Choose Our Local SEO Agency In India?</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>How Does A Local SEO Company Help?</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>Google My Business Listing Optimization</h1>
          ...
          <div className='w-[400px] h-[500px] border-gray-500 border-2 justify-center items-center text-center mx-auto m-2 overflow-hidden'>
            <img src={img1} />
          </div>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>Optimize Your Website For Better Local SEO</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>Building Local Citations And Backlinks From Local Websites</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>Getting Reviews, Reply To The Reviews, And Answering Questions</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>What Are The Benefits Of Local SEO Services?</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>It Helps You TO Drive Local Customers For Your Business</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>Local SEO Services Increase Your Website's Traffic</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-start'>Local SEO Helps You To Get More Conversions & Leads</h1>
        ...
        <Video1 />
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-center'>Local SEO Helps You To Get More Conversions & Leads</h1>
          <div className='bg-white w-full h-[340px] m-10 rounded-sm'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-3 text-sm justify-between mt-11 mx-auto'>
            <div className='h-[500px] w-[400px] bg-black mx-auto m-3'>
              <div className='bg-white w-[400px] h-[300px] rounded-sm mx-auto'>
                <img src="" alt='no-video' />
              </div>
              <div className='m-5'>
                <h1 className='text-white text-2xl mt-4 font-bold text-center '>White Hat SEO</h1>
            ...
            <div className='h-[500px] w-[400px] bg-black mx-auto m-3'>
              ...
              <div className='m-5'>
                <h1 className='text-white text-2xl mt-4 font-bold text-center '>Proof Of Work And Rankings</h1>
            ...
            <div className='h-[500px] w-[400px] bg-black mx-auto m-3'>
              ...
              <div className='m-5'>
                <h1 className='text-white text-2xl mt-4 font-bold text-center'>Pricing</h1>
        ...
        <div className='mt-[120px]'>
          <h1 className='text-white text-4xl mt-4 font-bold text-center'>Frequently Asked Questions</h1>
          <Questions faqs={faqs} />
        </div>
        <div className='mt-14'>
